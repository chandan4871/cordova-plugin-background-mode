@echo off
REM ========================================================================
REM Infrastructure Tagging Summary Generation - Windows Batch Script (SDE)
REM ========================================================================
REM 
REM This batch file runs the infrastructure tagging summary generation
REM using SDE connection. Edit the variables below to match your setup.
REM
REM Usage: run_job_sde.bat
REM ========================================================================
...
REM Alternatively, you can specify parameters directly:
REM SET SDE_PATH=C:\temp\SDE_Conn\ONETOOLDEV_ONETOOL_ARCGIS_CONN_SQL.sde
REM SET SCHEMA_NAME=ONETOOLAPP.
REM SET LOG_FOLDER=C:\temp\GPLogs
